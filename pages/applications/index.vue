    ...
    <div class="search mb-[60px]">
      ...
      >
        <input
          ...
          placeholder="Xostellar nomini kiriting"
        />
        <svg
    ...
    <div class="body">
      ...
      >
           <span slot="certificate" class="flex justify-center" slot-scope="text">
             <a v-if="text?.link" target="_blank" :href="text?.link" @click="preventOne">
               <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  ...
                  fill="#28303F"/>
                <path d="M16.3169 19V15.4209H18.7705V16.0264H17.0396V16.8735H18.5337V17.479H17.0396V19H16.3169Z"
                      fill="#28303F"/>
             </svg>
            </a>
           </span>
        <span slot="application" class="flex justify-center" slot-scope="text">
          <a :href="`${baseUrl}/generate-application/${text?.task_id}`" target="_blank" @click="preventOne">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="28" height="28" rx="14" fill="white"/>
              <path
          ...
          <span
            :class="{
              ...
              'status-success': text?.status === 'accepted',
               'status-progress-new': text?.pipe_status === 85,
            }"
          >
            <span v-if="text?.pipe_status === 85">
              Yangi (90 kun)
            </span>
          <span v-else> {{
              text?.user_canceled
...
export default {
  ...
  computed: {
    baseUrl() {
      return process.env && process.env.baseUrl
    },
  },
  mounted() {
    this.__GET_HOTELS();
...
:deep(.column-status .status-progress-new) {
  color: #b167f5;
}
